 ...
 *
 *    $Id: pick_ew.c,v 1.13 2007/03/13 14:42:08 paulf Exp $
 *
 *    Revision history:
 *     $Log: pick_ew.c,v $
...
int main( int argc, char **argv )
{
   ...
   long          *TraceLong;       /* Long pointer to waveform data */
...
/* Point to header and data portions of waveform message
   *****************************************************/
   ...
   TraceLong  = (long *) (TraceBuf + sizeof(TRACE_HEADER));

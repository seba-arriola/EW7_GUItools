...
c   Reset to generic phase codes so they will be used and reidentified.
	if(phase.eq.'Pg'.or.phase.eq.'Pn'.or.phase.eq.'Pb'.or.
	1	phase.eq.'P*') phase='P'
	if(phase.eq.'Sg'.or.phase.eq.'Sn'.or.phase.eq.'Sb'.or.
	1	phase.eq.'S*') phase='S'
c

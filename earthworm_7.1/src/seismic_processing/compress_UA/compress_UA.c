 ...
 *
 *    $Id: compress_UA.c,v 1.10 2007/02/26 13:44:40 paulf Exp $
 *
 *    Revision history:
 *     $Log: compress_UA.c,v $
 ...
 ******************************************************************/
   WaveLong  = (long *)  (WaveBuf.msg + sizeof(TRACE2_HEADER));
			...
			else if (k_its ("CompressSCNL")) 
			{
				if (nSCNL >= MaxSCNL) 
				{
                	        ...
                	        strcpy(GetSCNL[nSCNL].sta, str);
                                GetSCNL[nSCNL].wildsta = isWild( str );
                	        ...
                	        strcpy(GetSCNL[nSCNL].chan, str);
                                GetSCNL[nSCNL].wildchan = isWild( str );
                	        ...
                	        strcpy(GetSCNL[nSCNL].net, str);
                                GetSCNL[nSCNL].wildnet = isWild( str );
                	        ...
                	        strcpy(GetSCNL[nSCNL].loc, str);
                                GetSCNL[nSCNL].wildloc = isWild( str );

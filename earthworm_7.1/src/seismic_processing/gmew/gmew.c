 ...
 *
 *    $Id: gmew.c,v 1.9 2007/02/26 13:44:40 paulf Exp $
 *
 *    Revision history:
 *     $Log: gmew.c,v $
...
#define VERSION "v0.2.0 2006-03-13"
...
int main(int argc, char **argv)
{
  ...
  if (Configure(&gmParams, argc, argv, &event) < 0)
  {
    logit("e", "gmew: configuration failed; exitting\n");
    return 1;
  }

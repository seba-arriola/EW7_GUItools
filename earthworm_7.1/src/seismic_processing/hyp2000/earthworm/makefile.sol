...
#
#    $Id: makefile.sol,v 1.2 2000/09/12 22:15:59 dietz Exp $
#
#    Revision history:
#     $Log: makefile.sol,v $
...
hyate.o hyfmc.o hycal.o hysou.o hyxmc.o hycrh.o hycrt.o hystl.o hyopen.o \
hyinit.o hyphs.o hycin.o hycout.o hytrl.o hyloc.o hysol.o hysvd.o hytra.o \
hytrh.o hytrt.o hymag.o hyrep.o hylst.o hysum.o hyinp.o hypro.o medwt.o \
utmcal.o init_event.o hydelt.o hyedit.o hytime.o hybeg.o hypref.o spawn.o hyfile.o \
openr.o askr.o openw.o errset.o leng.o dayjl.o lask.o readq.o jask.o \
jdate.o klas.o upstr.o askc.o box2.o box3.o klass.o ksic.o
	f77 hypoinv-test.o hypoinv.o hybda.o hycmd.o hysta.o hydel.o \
	hyate.o hyfmc.o hypref.o hyxmc.o hycrh.o hycrt.o hystl.o hyopen.o \
	hyinit.o hyphs.o hycal.o hycin.o hytrl.o hyloc.o hysol.o hysvd.o \
	hytra.o hytrh.o hytrt.o hymag.o hyrep.o hylst.o hysum.o hyinp.o \
	hypro.o medwt.o utmcal.o init_event.o hydelt.o hyedit.o hytime.o hyfile.o \
	hybeg.o hycout.o hymagp.o hysou.o spawn.o openr.o askr.o openw.o \
	errset.o leng.o dayjl.o lask.o readq.o jask.o jdate.o klas.o \
	upstr.o askc.o box2.o box3.o klass.o ksic.o \
	-Bstatic -o $B/hypoinv2-test
...
hytrh.o hytrt.o hymag.o hyrep.o hylst.o hysum.o hyinp.o hypro.o medwt.o \
utmcal.o init_event.o hydelt.o hyedit.o hytime.o hybeg.o hypref.o spawn.o hyfile.o \
openr.o askr.o openw.o errset.o leng.o dayjl.o lask.o readq.o jask.o jdate.o \
klas.o upstr.o askc.o box2.o box3.o klass.o ksic.o

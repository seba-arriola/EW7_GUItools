C--HYP IS THE VAX VERSION OF THE LOCATION PROGRAM HYPOINVERSE. THE PROGRAM
C  IS DESIGNED TO BE FAST, FILE ORIENTED AND COMMAND DRIVEN.

C--WRITTEN BY FRED KLEIN, 10/2006 VERSION
...
1000  FORMAT (' HYPOINVERSE 2000 STARTING'/
     2' 2/2007 VERSION 1.1 (Can fix origin time)')

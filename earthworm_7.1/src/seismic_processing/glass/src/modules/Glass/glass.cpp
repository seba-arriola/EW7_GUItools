 ...
 *
 *    $Id: glass.cpp,v 1.2 2006/05/22 16:01:25 paulf Exp $
 *
 *    Revision history:
 *     $Log: glass.cpp,v $
...
int CGlass::DeleteOrigin(char * idOrigin)
{
  ...
  CDebug::Log(DEBUG_MAJOR_INFO, "Attempting to Delete origin %s\n", idOrigin);
...
//  returns:
//		0: No changes
//		1: Waifs associated, need to relocate

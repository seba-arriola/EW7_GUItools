...
#
#    $Id: makefile.sol,v 1.3 2002/11/03 18:56:14 lombard Exp $
#
#    Revision history:
#     $Log: makefile.sol,v $
#     Revision 1.3  2002/11/03 18:56:14  lombard
...
O = sniffwave.o $L/getutil.o $L/kom.o $L/transport.o $L/sleep_ew.o \
    $L/logit.o $L/time_ew.o $L/swap.o

sniffwave: $O
	cc -o $B/sniffwave $O -lm -lposix4

 ...
 *
 *    $Id: ew2seisvole.c,v 1.6 2007/02/26 16:48:07 paulf Exp $
 *
 *    Revision history:
 *     $Log: ew2seisvole.c,v $
        ...
        while(1)
                ...
                do
                        ...
                        *****************************/
                        ...
                        switch(res)
                                ...
                                sprintf( Text, "Retrieved msg[%ld] (i%u m%u t%u) too big for message[%d]",
                                         msgSize,msgLogo.instid, msgLogo.mod, msgLogo.type, sizeof(message) );
                    ...
                    logit("et","ew2seisvole generated message:\n <<%s>> \n", msgtext);
                                    ...
                                    sprintf (filename, "%sew2seisvole-%ld", TargetDirectory, time(NULL));
...
#define CUBIC_MSG_LEN 80
    ...
    /* Mag type */
    junk[0]= toupper(sumCard[MAG_LABEL_IND]);
    junk[1]='\0';

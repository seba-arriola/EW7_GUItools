...
@rem -------------------------------------
rem set SCHEMA_DIR=%EW_HOME%\%EW_VERSION%\src\oracle\schema-working
rem set APPS_DIR=%EW_HOME%\%EW_VERSION%\src\oracle\apps
...
@rem Set up Fortran v6 compilation environment with Intel 9 compiler
@rem ---------------------

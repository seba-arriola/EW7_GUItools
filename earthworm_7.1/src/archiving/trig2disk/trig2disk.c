 ...
 *
 *    $Id: trig2disk.c,v 1.23 2007/02/26 20:47:04 paulf Exp $
 *
 *    Revision history:
 *     $Log: trig2disk.c,v $
...
int main( int argc, char **argv )
{
    ...
    logit( "" , "trig2disk: Read command file <%s>\n", argv[1] );
...
thr_ret SnippetMaker( void *dummy )
{
	...
	for ( iTrReq = 0; iTrReq < nTrReq; iTrReq++) {
		...
		logit("", "Call to PA_next failed; exiting!\n");
		goto ShutdownSnippetMaker;
	    }

 ...
 *
 *    $Id: menlo_report_dk.c,v 1.1 2003/01/30 23:10:31 lucky Exp $
 *
 *    Revision history:
 *     $Log: menlo_report_dk.c,v $
 *     Revision 1.1  2003/01/30 23:10:31  lucky
 *     Initial revision
 *
...
static int     KeepLocal = 0;       /* =1 if KeepLocalCopy command is in  */
                                    /*    configuration file              */
static int     DoRemote  = 1;       /* =1 if doing remote storage of arcs */
...
/* Create name for local file using the event
   ...
   command ArcSuffix.
   Example:  199601211324_98.arc
             yyyymmddhhmm_xx.SUFFIX
 *********************************************/
   i = 0;
 ...
 ***************************/
  ...
  /*12*/    else if( k_its("TmpRemoteFile") ) {
        ...
        /* Set flag to prevent remote processing.
         **************************************************/
            else if( k_its("NoRemoteProcessing") ) {
                DoRemote = 0;
            }

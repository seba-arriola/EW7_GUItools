...
#
#    $Id: makefile.sol,v 1.1 2000/02/14 20:00:08 lucky Exp $
#
#    Revision history:
#     $Log: makefile.sol,v $
...
inspect_tank: inspect_tank.o
	cc -g -o $B/inspect_tank inspect_tank.o

read_index: read_index.o
	cc -g -o $B/read_index read_index.o

read_struct: read_struct.o
	cc -g -o $B/read_struct read_struct.o

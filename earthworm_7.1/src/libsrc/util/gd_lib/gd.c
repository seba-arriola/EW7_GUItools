 ...
 *
 *    $Id: gd.c,v 1.3 2007/03/28 14:24:46 paulf Exp $
 *
 *    Revision history:
 *     $Log: gd.c,v $
 *     Revision 1.3  2007/03/28 14:24:46  paulf
 *     minor unix and MACOSX changes
 *
 *     Revision 1.2  2000/05/12 16:30:03  davidk
 *     typecasted the return value of floor() to an int twice, to
 *     get rid of compiler warning messages on NT about a double
 *     being implicitly cast to an int.
 *
...
#ifndef _MACOSX
#include <malloc.h>
#endif /* _MACOSX - doesn't have malloc.h */

...
*/
      ...
      double C, C_sqr;
      double torad, todeg;
      double a, b, aa, bb, a0, b0;
      double g0, g2, g4, g6;
      double latrad, lonrad, azmrad;
      double ec, ec2, eps, eps0,       fl;
      double tanu1p, tanmu, sinu1, sinu2;
      double tanlat, coslat, sinlat, tanazm, sinazm, cosazm;
      double v1, u2, u1p, u2p, u1pbot, x2, y2, z2, ztop, zbot;
      double arg, temp,        mu, sd, sig1      ;
...
/*  Compute some of the easier terms               */
      ...
      tanu1p = tanlat / (cosazm*sqrt(1.0+eps0));
...
/*  This calculation of latitude is based on Rudoe's formulation, which has
    not been tested  */
...
/*  This calculation of longitude is based on Ruloe's formulation, which has
    not been tested  */

...
*****************************/
    ...
    ******************************************/
    if ( ( msg = (char *) malloc(MaxMsgSize) ) == (char *) NULL )
    {
...
thr_ret SocketSender( void *dummy )
{
    ...
    **************************************/
    ...
    if ( ( binMsg = (char *) malloc(maxBinSize) ) == (char *) NULL )
    {
        logit( "e",
...
thr_ret MessageStacker( void *dummy )
{
    ...
    ******************************************/
    ...
    if ( ( filteredMsg = (char *) malloc(MaxMsgSize) ) == (char *) NULL )
    {
    ...
    while( 1 )
    {
        ...
        ************************************/
        res = tport_getmsg( &Region, GetLogo, nLogo,
                                                &reclogo, &recsize, msg, MaxMsgSize-1 );

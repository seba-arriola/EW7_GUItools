 ...
 *
 *    $Id: ew_event_info.h,v 1.11 2004/08/12 22:48:19 davidk Exp $
 *
 *    Revision history:
 *     $Log: ew_event_info.h,v $
 *     Revision 1.11  2004/08/12 22:48:19  davidk
 *     Added prototype for CleanupEWEvent(), which deallocates memory from and resets pointers in
 *     an EWEventInfoStruct.
 *
 *     Revision 1.10  2004/06/10 18:51:11  davidk
 *     There were two version of this file, the other was in ew/include.  I am updating this

 ...
 *
 *    $Id: yelstone_polygon.c,v 1.3 2001/08/06 20:22:31 lucky Exp $
 *
 *    Revision history:
 *     $Log: yelstone_polygon.c,v $
 ...
 *
 *     Revision 1.1  2001/05/18 19:08:05  lucky
 *     Initial revision
 *
...
int	DoCheck(EWEventInfoStruct *pEvt)
{
	...
	xRect[0] = (float)44.00; yRect[0] = (float)-109.75;
	xRect[1] = (float)44.00; yRect[1] = (float)-111.50;
	xRect[2] = (float)45.17; yRect[2] = (float)-111.50;
	xRect[3] = (float)45.17; yRect[3] = (float)-109.75;
	xRect[4] = (float)44.00; yRect[4] = (float)-109.75;

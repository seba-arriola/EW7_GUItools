...
#
#                                        
#           sta     name      delay buf nsoh  type label   min max   type label    min max   type label    min max  
#-----------------------------------------------------------------------------------------------------------------
# example HRD:
RequestSOH  KRM   "Red Mtn"     10   1   2      HV voltage 10.5 15.    HT     temp -10  40 
# example Libra:
RequestSOH  CAR05  CarinaA      10   1   3      HV HRDvolt 10.5 15.  LTXT   TXtemp -10  40   LES1  ACstatus 0  2.5
RequestSOH  KSX   "Camp Six"    10   1   3      LV LNXvolt 10.5 15.  LSST SSPBtemp -10 100   LES1 TEGstatus 0  2.5

...
export EW_HOME="/home/ew8/earthworm"
export EW_VERSION="earthworm_7.1"
export SYS_NAME="ew8"
...
export EW_PARAMS=${EW_HOME}/run_working/params/
export EW_LOG=${EW_HOME}/run_working/logs/
...
export GLOBALFLAGS="-Dlinux -D__i386 -D_LINUX -D_INTEL -D_USE_SCHED  -D_USE_PTHREADS -D_USE_TERMIOS -I${EW_HOME}/${EW_VERSION}/include -I/usr/include/tirpc -fcommon" 

...
void ReportPick( PPICK *P, STATION *Sta, unsigned char ucMyModID,
   ...
   ***************************/
   if ( iType == 1 )        /* Data from lpproc */
      snprintf( line, sizeof(line), "%d %d %d %s %s %s %ld %d %lf %c %s %lf %lf %lf %lf "
             ...
             P->dMbTime, P->dMlAmpGM, P->dMlPer, P->dMlTime,
   ...
   if ( iType == 4 )        /* Data from pick_wcatwc */
      snprintf( line, sizeof(line), "%d %d %d %s %s %s %ld %d %lf %c %s %lf %lf %lf %lf "
             ...
             Sta->dMbAmpGM, (double) Sta->lMbPer/10., Sta->dMbTime,
             Sta->dMlAmpGM, (double) Sta->lMlPer/10., Sta->dMlTime, 0., 0., 0.,
   ...
   ********/
   ...
   if ( iType == 1 )        /* Data from lpproc */
      logit( "et", "%s %s %lf, MSamp=%lf, MSPer=%lf, MSTime=%lf\n",
       P->szStation, asctime( TWCgmtime( lTemp ) ), P->dPTime, P->dMSAmpGM,
       P->dMSPer, P->dMSTime );
      ...
      logit( "et", "%s, P-time=%s %c P=%lf, Mbamp=%lf, MbPer=%lf, MbTime=%lf,"
       ...
       P->szStation, asctime( TWCgmtime( lTemp ) ), P->cFirstMotion, P->dPTime,
       P->dMbAmpGM, P->dMbPer, P->dMbTime, P->dMlAmpGM, P->dMlPer, P->dMlTime,
       P->dMwpTime, P->dMwpIntDisp );
